...
function [SCRPTipt,SCRPTGBL,err] = DblC_FSFS3DRad_v1a(SCRPTipt,SCRPTGBL)
...
if imageshow == 1
    ...
    IMSTRCT.rows = rows; IMSTRCT.lvl = [0 max(abs(tTF(:)))*1.05]; IMSTRCT.docolor = 1; IMSTRCT.ColorMap = 'ColorMap4'; IMSTRCT.SLab = 1; IMSTRCT.figsize = []; IMSTRCT.figno = 400; 
...
if strcmp(button,'Yes')
    KRNprms.type = 'DblC_FSFS3DRad_v1';
    KRNprms.DblKern.convscaleval = ConvScaleVal;
