...
function [SCRPTipt,SCRPTGBL,err] = Kaiser3DCart_v2(SCRPTipt,SCRPTGBL)
...
if strcmp(button,'Yes')
    ...
    name = ['KBv2_W',num2str(W,2),'_R',num2str(res,3),'_B',num2str(beta,3),'_zW',num2str(zW,3)];
    KRNprms.name = regexprep(name,'\.', 'p');

    path = ['D:\1 Scripts\zs Shared\zy Convolution Kernels\Kaiser_v2\',KRNprms.name];
    mkdir(path);
