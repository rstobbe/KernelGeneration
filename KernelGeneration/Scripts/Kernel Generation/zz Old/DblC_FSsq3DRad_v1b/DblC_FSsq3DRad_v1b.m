%==================================================
% (v1b) 
%   - backup posterity / commenting changes  
%   - update for RWSUI_B9 
%==================================================

function [SCRPTipt,SCRPTGBL,err] = DblC_FSsq3DRad_v1b(SCRPTipt,SCRPTGBL)
...
SS = str2double(SCRPTGBL.CurrentScript.TestForSS); 
...
% Output
%--------------------------------------------
KRNprms.type = 'DblC_FSsq3DRad_v1b';
...
name = ['Kern_FSsqRw',num2str(W,2),'bw',num2str(BW,3),'b',num2str(beta,3),'ss',num2str(SS,3)];
