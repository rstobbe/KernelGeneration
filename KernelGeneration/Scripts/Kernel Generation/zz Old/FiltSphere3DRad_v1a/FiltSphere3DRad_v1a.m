...
function [SCRPTipt,SCRPTGBL,err] = FiltSphere3DRad_v1a(SCRPTipt,SCRPTGBL)
...
if strcmp(button,'Yes')
    ...
    name = ['FSphR_W',num2str(W,2),'_BW',num2str(BW,3),'_B',num2str(beta,3)];
