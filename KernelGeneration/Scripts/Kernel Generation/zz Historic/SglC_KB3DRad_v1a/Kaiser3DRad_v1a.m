...
function [SCRPTipt,SCRPTGBL,err] = Kaiser3DRad_v1a(SCRPTipt,SCRPTGBL)
...
for a = 1:N
    for b = 1:N
        for c = 1:N
            ...
            if rad < 1
                Rad(a,b,c) = rad;
                Kern(a,b,c) = lin_interp4(KBProf,rad,L);
            end
        end
    end
    Status2('busy',num2str(N-a),2);    
...
if strcmp(button,'Yes')
    ...
    name = ['KBR_W',num2str(W,2),'_B',num2str(beta,3)];
