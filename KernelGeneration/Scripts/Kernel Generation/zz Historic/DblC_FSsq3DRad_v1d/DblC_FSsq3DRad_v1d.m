...
%   - Update for integer W with SS
%==================================================

function [SCRPTipt,SCRPTGBL,err] = DblC_FSsq3DRad_v1d(SCRPTipt,SCRPTGBL)
...
% Output
%--------------------------------------------
KRNprms.type = 'DblC_FSsq3DRad_v1d';
