...
function [SCRPTipt,SCRPTGBL,err] = KernAnlzForGridding1D_v1a(SCRPTipt,SCRPTGBL)

err.flag = 0;
err.msg = '';

AllTrees = SCRPTGBL.AllTrees;
if not(isfield(AllTrees,'ConvKernGen'))
    err.flag = 1;
    err.msg = '''ConvKernGen''-type script must also be loaded';
end
